...
- 86d9318: Add review reactions support
  • Endpoints to create and delete emoji reactions on reviews with ownership tracking
  • Reactions included in review list and detail responses

## 0.14.0

### Minor Changes

- 129e122: Restrict user updates to profile fields with avatar support and normalize member/review responses
...
- d0811bb: Group invite link system with role-based authorization
